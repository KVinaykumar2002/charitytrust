...
const images: ImageData[] = [
  {
    ...
    url: "https://www.cinejosh.com/newsimg/newsmainimg/chiranjeevi-on-world-blood-donation-day_b_1506220926.jpg",
  },
  {
    title: "Medical Camp",
    url: "https://img1.wsimg.com/isteam/ip/3f9bf7ba-9991-425c-8ad7-3fa919af01f1/cct1.jpeg/:/cr=t:19.74%25,l:9.68%25,w:80.65%25,h:60.52%25/rs=w:600,h:300,cg:true,m",
  },
  {
    title: "Charity Event",
    url: "https://assets.hmtvlive.com/h-upload/2023/07/09/357070-chiranjeevi-charitable-trust.webp",
  },
  {
    title: "Partnership Program",
    url: "https://img.ap7am.com/froala-uploads/20240126fr65b342713b414.jpg",
  },
  {
    title: "Community Outreach",
    url: "https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=600&h=600&auto=format&fit=crop",
  },
  {
    title: "Eye Donation Campaign",
    url: "https://images.unsplash.com/photo-1587829741301-dc798b83add3?q=80&w=600&h=600&auto=format&fit=crop",
  },
]
...
export function ImageGallery() {
  ...
  return (
    <div className="flex items-center justify-center bg-primary rounded-3xl py-12 md:py-16 font-sans relative overflow-hidden">
      ...
      <button
        className="absolute right-[calc(50%-35vmin-40px)] sm:right-[calc(50%-275px-50px)] top-1/2 z-[101] flex h-14 w-14 sm:h-16 sm:w-16 -translate-y-1/2 translate-x-1/2 cursor-pointer items-center justify-center rounded-full border-2 border-white/20 bg-white/95 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.12)] outline-none transition-all duration-300 ease-out hover:scale-110 hover:bg-white hover:border-white/40 hover:shadow-[0_12px_48px_rgba(0,0,0,0.18)] active:scale-95 focus-visible:ring-4 focus-visible:ring-white/50 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
        onClick={next}
        disabled={disabled}
