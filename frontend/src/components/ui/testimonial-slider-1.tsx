...
interface TestimonialSliderProps {
  ...
  className?: string;
  /** Auto-scroll interval in milliseconds (default: 5000ms = 5 seconds) */
  autoScrollInterval?: number;
  /** Whether to pause auto-scroll on hover (default: true) */
...
export const TestimonialSlider = ({
  ...
  }, [reviews.length, autoScrollInterval, isPaused]);
